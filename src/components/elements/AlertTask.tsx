...
export default function AlertTask({ title, message }: Props) {
    ...
    return (
        <div className={`bg-${color}-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md my-5`} role="alert">
            <div className="flex">
